...
<?php
 if(isset($_POST['add_cat'])){
   ...
   if(empty($errors)){
      ...
      $sql .= " VALUES ('{$cat_name}') ON DUPLICATE KEY UPDATE name=VALUES(`name`)";
   

      if($db->query($sql)){
        $session->msg("s", "{$cat_name} Agregada Correctamente");
        redirect('categorie.php',false);
      } else {
        $session->msg("d", "Error al Insertar Modelo.");
        redirect('categorie.php',false);
      }
   } else {
     $session->msg("d", "El nombre de la categoría no puede estar en blanco.");
     redirect('categorie.php',false);
   }
 }
?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Agregar Nuevos Modelos</span>
         </strong>
        </div>
        ...
        <div class="panel-body">
          <form method="post" action="categorie.php">
            <div class="form-group">
                <input type="text" class="form-control" name="categorie-name" placeholder="Nombre del Modelo ">
            </div>
