...
//update user image
  ...
  if($photo->process_user($user_id)){
    $session->msg('s','Foto de perfil Actualiada Correctamente.');
  ...
  <div class="col-md-6">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
                <img class="img-circle img-size-2" src="uploads/users/imagen.jpg">
            </div>
            <div class="col-md-8">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <div class="form-group">
                  <label for="username" class="control-label">Nombe de Acceso</label>
